...
exports.sortableList = ng_start_1.ng.directive('sortableList', function ($compile) {
    return {
        restrict: 'A',
        controller: function () { },
...
exports.sortableElement = ng_start_1.ng.directive('sortableElement', function ($parse) {
    return {
        scope: {
            ngModel: '=',
            ngChange: '&'
